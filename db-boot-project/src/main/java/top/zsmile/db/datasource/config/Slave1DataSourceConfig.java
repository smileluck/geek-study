...
public class Slave1DataSourceConfig {
    ...
    public SqlSessionFactory db1SqlSessionFactory(@Qualifier("slave1DataSource") DataSource dataSource) throws Exception {
    ...
    @Bean("slave1SqlSessionTemplate")
    public SqlSessionTemplate db1SqlSessionTemplate(@Qualifier("slave1SqlSessionFactory") SqlSessionFactory sqlSessionFactory) {
