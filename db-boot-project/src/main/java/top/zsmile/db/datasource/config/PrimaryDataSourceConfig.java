...
public class PrimaryDataSourceConfig {
    ...
    public SqlSessionFactory db1SqlSessionFactory(@Qualifier("primaryDataSource") DataSource dataSource) throws Exception {
    ...
    public SqlSessionTemplate db1SqlSessionTemplate(@Qualifier("primarySqlSessionFactory") SqlSessionFactory sqlSessionFactory) {
